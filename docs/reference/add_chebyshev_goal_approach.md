...
Add a Chebyshev goal approach for multi-objective optimization to a
project problem (Jones and Tamiz 2010).

## Usage

``` r
add_chebyshev_goal_approach(x, weights, goals, verbose = TRUE)
```
...
The Chebyshev goal approach for multi-objective optimization involves
...
calculates the new objectives based on the weighted maximum of the
...
#> approach:          Chebyshev goal approach
