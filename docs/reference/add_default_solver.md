...
Add the best solver currently installed to a project prioritization
problem.
...
This function does not consider solvers that generate solutions using
heuristic algorithms (i.e.
[`add_heuristic_solver()`](https://prioritizr.github.io/oppr/reference/add_heuristic_solver.md))
or random processes (i.e.,
[`add_random_solver()`](https://prioritizr.github.io/oppr/reference/add_random_solver.md))
because they cannot provide any guarantees on solution quality.
