...
extern SEXP _ppr_rcpp_get_optimization_problem_compressed_formulation(SEXP);
...
extern SEXP _ppr_rcpp_get_optimization_problem_number_of_planning_units(SEXP);
extern SEXP _ppr_rcpp_get_optimization_problem_number_of_zones(SEXP);
...
extern SEXP _ppr_rcpp_set_optimization_problem_shuffled(SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ppr_rcpp_get_optimization_problem_compressed_formulation",   (DL_FUNC) &_ppr_rcpp_get_optimization_problem_compressed_formulation,   1},
    ...
    {"_ppr_rcpp_get_optimization_problem_number_of_planning_units", (DL_FUNC) &_ppr_rcpp_get_optimization_problem_number_of_planning_units, 1},
    {"_ppr_rcpp_get_optimization_problem_number_of_zones",          (DL_FUNC) &_ppr_rcpp_get_optimization_problem_number_of_zones,          1},
    ...
    {"_ppr_rcpp_set_optimization_problem_shuffled",                 (DL_FUNC) &_ppr_rcpp_set_optimization_problem_shuffled,                 1},
    {NULL, NULL, 0}
};
