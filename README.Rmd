...
The development version of the _oppr R_ package can be installed using the following code. Please note that you will need install the _ggtree_ package from Bioconductor since it is not available on [The Comprehensive R Archive Network](https://cran.r-project.org/).
...
Here we will provide a short example showing how the _optimalppp R_ package can be used to prioritize funding for conservation projects. To start off, we will set the seed for the random number generator to ensure you get the same results as shown here, and load the _oppr R_ package.
