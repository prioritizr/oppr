...
Thank you very much for reviewing this submission. In particular, this submission contains an update for the *oppr* package that has previously been published on CRAN. It contains updates to provide new functionality for multi-objective optimization, reduce memory usage by using the _R6_ class system for objective oriented programming, and updates to improve compatibility with dependencies (e.g., _ggplot2_ package).
