...
test_that("valid arguments", {
  ...
  # simulate data
  s <- simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01, 0.4, 0.01,
    0.01
  )
...
test_that("invalid arguments", {
  # number projects
  expect_error(simulate_ptm_data(
    -1, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    0.5, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    NA_integer_, 8, 5, 100, 5, 0.7, 0.99, 0.5,
    0.9, 0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    "a", 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # number actions
  expect_error(simulate_ptm_data(
    6, -1, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 0.5, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, NA_integer_, 5, 100, 5, 0.7, 0.99, 0.5,
    0.9, 0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, "a", 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # number features
  expect_error(simulate_ptm_data(
    6, 8, -1, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 0.5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, NA_integer_, 100, 5, 0.7, 0.99, 0.5,
    0.9, 0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, "a", 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # cost mean
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, -1, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, NA_real_, 5, 0.7, 0.99, 0.5,
    0.9, 0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, "a", 5, 0.7, 0.99, 0.5, 0.9,
    0.01, 0.4, 0.01, 0.01
  ))
  # cost sd
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, -1, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, NA_real_, 0.7, 0.99, 0.5, 0.9,
    0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, "a", 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # success_min_probability
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, -0.1, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 1.1, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, NA_real_, 0.99, 0.5, 0.9,
    0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, "a", 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # success_max_probability
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 1.1, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, -0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, "a", 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, NA_real_, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.6, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # funded_min_persistence_probability
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, -0.1, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 1.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, "a", 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, NA_real_, 0.9,
    0.01, 0.4, 0.01, 0.01
  ))
  ...
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, 1.9,
    0.01, 100, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, "a", 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, NA_real_,
    0.01, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.3, 0.01,
    0.4, 0.01, 0.01
  ))
  ...
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, 1.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, "a",
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ptm_data(
    6, 8, 5, 100, 5, 0.7, 0.99, 0.5, 0.9, NA_real_,
    0.4, 0.01, 0.01
  ))
