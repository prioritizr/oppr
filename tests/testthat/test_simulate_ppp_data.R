...
test_that("valid arguments", {
  ...
  expect_equal(unique(vapply(
    s$projects[, paste0("F", seq_len(5)),
      drop = FALSE
    ], class,
    character(1)
  )), "numeric")
  expect_equal(
    rowSums(as.matrix(s$projects[, paste0("F", seq_len(5)),
      drop = FALSE
    ]) > 0, na.rm = TRUE),
    c(rep(1, 5), 5)
  )
...
test_that("invalid arguments", {
  # number species
  expect_error(simulate_ppp_data(
    -1, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    0.5, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    NA_integer_, 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    "a", 100, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # cost mean
  expect_error(simulate_ppp_data(
    100, -1, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, NA_real_, 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, "a", 5, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # cost sd
  expect_error(simulate_ppp_data(
    100, 100, -1, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, NA_real_, 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, "a", 0.7, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # success_min_probability
  expect_error(simulate_ppp_data(
    100, 100, 5, -0.1, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 1.1, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, NA_real_, 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, "a", 0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # success_max_probability
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 1.1, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, -0.99, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, "a", 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, NA_real_, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.6, 0.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # funded_min_persistence_probability
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, -0.1, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 1.5, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, "a", 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, NA_real_, 0.9, 0.01,
    0.4, 0.01, 0.01
  ))
  # funded_max_persistence_probability
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, -0.9, 0.01, 0.4,
    0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, 1.9,
    0.01, 100, 0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, "a", 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, NA_real_, 0.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, 0.3, 0.01,
    0.4, 0.01, 0.01
  ))
  ...
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, 0.9, 1.01,
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, 0.9, "a",
    0.4, 0.01, 0.01
  ))
  expect_error(simulate_ppp_data(
    100, 100, 5, 0.7, 0.99, 0.5, 0.9, NA_real_,
    0.4, 0.01, 0.01
  ))
