...
test_that("add_phylo_div_objective (single solution)", {
  # create data
...
test_that("add_phylo_div_objective (multiple solutions)", {
  # create data
  projects <- tibble::tibble(
    name = letters[1:4],
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_targets_met (single solution)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_targets_met (single feasible solution)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_targets_met (locked constraints)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_min_set_objective (simple problem, single solution)", {
  # create data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_min_set_objective (simple problem, multiple solutions)", {
  # create data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_min_set_objective (locked constraints, multiple solutions)", {
  # create data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_wtd_sum_objective (single solution)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_wtd_sum_objective (shared actions)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_wtd_sum_objective (locked constraints)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_wtd_sum_objective (zero budget)", {
  # make data
  projects <- tibble::tibble(
    name = c("P1", "P2", "P3", "P4"),
    success = c(0.95, 0.96, 0.94, 1.00),
...
test_that("add_max_wtd_sum_objective (large problem, inc budgets)", {
  # make data
  set.seed(1000)
...
test_that("add_max_wtd_sum_objective (large problem, locked constraints)", {
  # make data
  set.seed(1000)
  sim_data <- simulate_ptm_data(
    number_projects = 70, number_actions = 30,
...
test_that("add_max_wtd_sum_objective (large problem, low budget)", {
  # make data
  set.seed(1000)
  sim_data <- simulate_ptm_data(
    number_projects = 70, number_actions = 30,
